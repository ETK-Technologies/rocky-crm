    ...
    Array.from({ length: 100 }, (_, i) => {
      ...
      return {
        ...
        medication: [
          ...
          ...(id % 3 === 0
            ? [{ name: `ExtraMed ${id}`, dose: `${50 + (id % 4) * 25} mg` }]
            : []),
        ],
        prescriber: `Dr. ${
          ["Smith", "Adams", "Lee", "Carter", "Patel"][id % 5]
        }`,
        prescribed_date: `${String((id % 28) + 1).padStart(2, "0")} ${
          [
            "Jan",
            "Feb",
            "Mar",
    ...
    <div className="space-y-6">
      ...
      <div className="mb-8">
        <PageHeader
          ...
          title="Prescriptions"
          description="Manage and track all prescription records and medications"
          actions={
