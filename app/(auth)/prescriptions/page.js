  ...
  const [prescriptions] = useState(
    Array.from({ length: 100 }, (_, i) => {
      ...
      return {
        ...
        medication: [
          { name: `Medication ${id}`, dose: `${100 + (id % 5) * 50} mg` },
          ...(id % 3 === 0 ? [{ name: `ExtraMed ${id}`, dose: `${50 + (id % 4) * 25} mg` }] : [])
        ],
        prescriber: `Dr. ${['Smith', 'Adams', 'Lee', 'Carter', 'Patel'][id % 5]}`,
        prescribed_date: `${String((id % 28) + 1).padStart(2, '0')} ${['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'][id % 12]}, 2025`,
        dosage: `${100 + (id % 5) * 50}mg`,
        frequency: ["Once daily", "Twice daily", "Three times daily"][id % 3],
        startDate: `2023-${String(((id % 12) + 1)).padStart(2, '0')}-01`,
        endDate: `2023-${String(((id % 12) + 1)).padStart(2, '0')}-10`,
        status: id % 4 === 0 ? "inactive" : "active",
        orderStatus: ["Under Review", "Completed", "Cancelled"][id % 3],
      };
    })
  );
        ...
        <>
          <div className="flex items-center justify-start gap-2">
            <div className="relative group flex flex-col items-center">
              ...
              <span className="absolute -top-8 left-1/2 -translate-x-1/2 scale-0 group-hover:scale-100 transition bg-gray-900 text-white text-xs rounded px-2 py-1 whitespace-nowrap z-10">View Order</span>
            </div>
            <div className="relative group flex flex-col items-center">
              <Button variant="outline" size="sm">
                <svg
              ...
              <span className="absolute -top-8 left-1/2 -translate-x-1/2 scale-0 group-hover:scale-100 transition bg-gray-900 text-white text-xs rounded px-2 py-1 whitespace-nowrap z-10">Download Order</span>
            </div>
            <div className="relative group flex flex-col items-center">
              <Button variant="outline" size="sm">
                <svg
              ...
              <span className="absolute -top-8 left-1/2 -translate-x-1/2 scale-0 group-hover:scale-100 transition bg-gray-900 text-white text-xs rounded px-2 py-1 whitespace-nowrap z-10">Copy Order</span>
            </div>
          </div>
        </>
      ),
