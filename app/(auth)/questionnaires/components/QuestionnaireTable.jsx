      ...
      cell: (row) => (
        <div>
          <div className="font-medium">
            <a
              href={`/questionnaires/${row.id}/view`}
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex items-center space-x-2">
          <a
            href={`/questionnaires/${row.id}/view`}
            className="inline-flex items-center px-3 py-1.5 text-xs font-medium text-primary-600 bg-primary-50 border border-primary-200 rounded-md hover:bg-primary-100 hover:text-primary-700 transition-colors"
          >
            <svg
