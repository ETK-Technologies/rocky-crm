...
export default function EditScannerPage() {
  ...
  // Dummy data for the scanned document
  const ScannedDocument = {
    id: params?.id,
    title: "Sample Prescription",
    docType: "prescription",
    order: "12345",
    // file/cameraFile left null for demo
  };
  const [formData, setFormData] = useState({
    title: ScannedDocument.title,
    docType: ScannedDocument.docType,
    order: ScannedDocument.order,
    file: null,
    cameraFile: null,
  });
