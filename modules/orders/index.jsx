...
function filterOrders(data, filters, searchQuery) {
    return data.filter(order => {
        ...
        filters.forEach(filter => {
            ...
            if (filter.type === "date-range" && filter.value.start && filter.value.end) {
                const dateField = filter.id === "created" ? "createdDate" : "updatedDate";
                match =
                    match &&
...
const OrderPage = () => {
    ...
    const handleFilterReset = () => {
        setFilters(defaultFilters.map(f => ({
            ...f,
    ...
    const filteredData = filterOrders(ordersData, filters, searchQuery).sort((a, b) => {
